...
export const sidenavMenuItems = [
    new SidenavMenu(1, '我要坐車', '/about-us', null, null, false, 0),
    new SidenavMenu(2, '我要接單', '/about-us', null, null, false, 0),
    new SidenavMenu (3, '關於我們', '/about-us', null, null, false, 0),
    new SidenavMenu(3, '使用者條款', '/about-us', null, null, false, 0),
    new SidenavMenu(4, '隱私權政策', '/about-us', null, null, false, 0),
]
